...
public class ModeSelectionScreen extends Screen {
    ...
    protected List<WandModesType> modes;
    protected Consumer<WandModesType> callback;
    ...
    public ModeSelectionScreen(List<WandModesType> modes, Consumer<WandModesType> callback) {
    ...
    public void setSelectedElement(WandModesType mode) {
