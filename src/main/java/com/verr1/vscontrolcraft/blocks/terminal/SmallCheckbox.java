...
public class SmallCheckbox extends AbstractButton {
    ...
    private static final AllVSCCGuiTextures BUTTON_ON = AllVSCCGuiTextures.SMALL_BUTTON_GREEN;
    private static final AllVSCCGuiTextures BUTTON_OFF = AllVSCCGuiTextures.SMALL_BUTTON_RED;
