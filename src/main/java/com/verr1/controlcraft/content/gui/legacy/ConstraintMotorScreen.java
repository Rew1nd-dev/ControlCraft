...
public class ConstraintMotorScreen extends SimpleSettingScreen{
    ...
    public ConstraintMotorScreen(BlockPos pos, double value, double target, double offset, double compliance) {
        super(pos);
        this.value = value;
        this.target = target;
        this.offset = offset;
    ...
    public void startWindow() {
        ...
        addNumericFieldWithLabel(ExposedFieldType.OFFSET.asComponent(), ParseUtils::tryParseDoubleFilter, true)
                .setValue(String.format("%.2f", offset));
    ...
    protected @Nullable ItemStack renderedStack() {
        return ControlCraftBlocks.CONSTRAINT_SERVO_MOTOR_BLOCK.asStack();
    }
}
