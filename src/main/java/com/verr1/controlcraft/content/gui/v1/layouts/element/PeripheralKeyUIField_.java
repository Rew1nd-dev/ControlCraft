...
public class PeripheralKeyUIField_ extends NetworkUIPort<PeripheralKey> implements TitleLabelProvider {
    ...
    public PeripheralKeyUIField_(Consumer<PeripheralKey> write, Supplier<PeripheralKey> read) {
        super(write, read);
    }
