...
public class BooleanUIField extends NetworkUIPort<Boolean> implements TitleLabelProvider {
    private final FormattedLabel title;
    private final SmallCheckbox field;

    public BooleanUIField(Consumer<Boolean> write, Supplier<Boolean> read, Component titleText) {
        super(write, read);
    ...
    public BooleanUIField(Consumer<Boolean> write, Supplier<Boolean> read, LabelProvider titleText) {
        super(write, read);
