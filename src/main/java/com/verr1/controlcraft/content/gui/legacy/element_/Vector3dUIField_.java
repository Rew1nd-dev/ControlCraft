...
public class Vector3dUIField_ extends NetworkUIPort<Vector3dc> implements TitleLabelProvider {
    ...
    public Vector3dUIField_(Consumer<Vector3dc> write, Supplier<Vector3dc> read, Component titleText, int fieldLength) {
        super(write, read);
    ...
    public Vector3dUIField_(Consumer<Vector3dc> write, Supplier<Vector3dc> read, LabelProvider titleText, int fieldLength) {
        super(write, read);
