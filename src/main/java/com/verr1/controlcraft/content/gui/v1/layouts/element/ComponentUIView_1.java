...
public class ComponentUIView_1 extends NetworkUIPort<Component> implements TitleLabelProvider {
    ...
    public ComponentUIView_1(Supplier<Component> read, Component titleText) {
        super($ -> {}, read);
        this.title.text = titleText;
        this.title.setWidth(Minecraft.getInstance().font.width(titleText));
    }

    public ComponentUIView_1(Supplier<Component> read, LabelProvider titleText) {
        super($ -> {}, read);
