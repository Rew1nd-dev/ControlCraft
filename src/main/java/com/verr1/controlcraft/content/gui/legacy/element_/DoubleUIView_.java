...
public class DoubleUIView_ extends NetworkUIPort<Double> implements TitleLabelProvider {


    private final FormattedLabel title;
    private final EditBox field;

    public DoubleUIView_(Supplier<Double> read, Component titleText) {
        super($ -> {}, read);
    ...
    public static DoubleUIView_ of(Supplier<String> read, Component titleText) {
        return new DoubleUIView_(
                () -> ParseUtils.tryParseDouble(read.get()),
                titleText
        );
    }

    public DoubleUIView_(Supplier<Double> read, LabelProvider titleText) {
        super($ -> {}, read);
    ...
    public static DoubleUIView_ of(Supplier<String> read, LabelProvider titleText) {
        return new DoubleUIView_(
                () -> ParseUtils.tryParseDouble(read.get()),
                titleText
        );
